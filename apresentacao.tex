...
\begin{frame}{Objetivos}
    ...
    \begin{itemize}[<+- | uncover@+>]
        ...
        \item Verificar sua aplicação \empy{na prática}; e
...
\hline
alternativa1 &                1 &                2 &                2 &     5 \\
\hline
alternativa2 &                2 &                1 &                1 &     4 \\
\hline
alternativa3 &                3 &                3 &                3 &     9 \\
\hline
\end{tabular}
    \caption{Tabela com dados ordenados}
...
\begin{frame}{Método de Condorcet}
\framesubtitle{Exemplo}
    
\only<1>{
\begin{block}{}
\centering
    Matriz de Decisão (Condorcet)
\end{block}
